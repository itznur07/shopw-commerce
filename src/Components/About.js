  ...
  return (
    <>
      ...
      <div className='md:mx-20 mt-5'>
        ...
        <p className="text-slate-700 italic mt-5 text-xl">“ Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model search for evolved over sometimes by accident, sometimes on purpose ”</p>
      </div>
      <div>
        <WhyChooseUs />
      </div>
